          ...
          <div className="flex flex-col gap-10">
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="flex gap-2">
                <Link href="https://twitter.com/vcoalec" target="_blank">
                  <svg
                ...
                <Link href="https://github.com/voalec" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <Link href="https://linkedin.com/in/voalec" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <Link href="https://voalec.hashnode.dev" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
