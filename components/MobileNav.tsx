  ...
  return (
    <section className="w-full max-w-[264px]">
      <Sheet>
        ...
        <SheetContent side="left" className="mobilenav flex flex-col justify-between">
          <div className="flex flex-col gap-10">
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="flex gap-2">
                <Link href="https://twitter.com/briansuyi" target="_blank">
                  <svg
                ...
                <Link href="https://github.com/bsuyi" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <Link href="https://linkedin.com/in/bsuyi" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <Link href="https://bsuyi.hashnode.dev" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
          ...
          <div className="text-center text-sm">
            <p>Copyright &copy; 2024 - <a href="/">Bsuyi</a></p>
          </div>
        </SheetContent>
      </Sheet>
    </section>
